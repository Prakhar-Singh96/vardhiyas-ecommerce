                    ...
                    <div class="d-flex align-items-start row">
                        ...
                        <div class="col-sm-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-6">
                                <img src="{{ url('admin/assets/img/illustrations/man-with-laptop.png') }}" height="175"
                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ url('admin/assets/img/icons/unicons/wallet-info.png') }}"
                    ...
                    <div class="col-6 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ url('admin/assets/img/icons/unicons/paypal.png') }}" alt="paypal"
                                            class="rounded" />
                                    </div>
                                    <div class="dropdown">
                        ...
                        <div class="tab-content p-0">
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex mb-6">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('admin/assets/img/icons/unicons/wallet-primary.png') }}"
                                            alt="User" />
                                    </div>
                                    <div>
                    ...
                    <div class="card-body pt-4">
                        <ul class="p-0 m-0">
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ url('admin/assets/img/icons/unicons/paypal.png') }}" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ url('admin/assets/img/icons/unicons/chart.png') }}" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ url('admin/assets/img/icons/unicons/cc-primary.png') }}" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ url('admin/assets/img/icons/unicons/cc-warning.png') }}" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        <div class="badge bg-lighter rounded-2">
                                            <img src="{{ url('admin/assets//img/icons/misc/pdf.png') }}" alt="img"
                                                width="15" class="me-2" />
                                    ...
                                    <div class="d-flex justify-content-between flex-wrap gap-2">
                                        <div class="d-flex flex-wrap align-items-center">
                                            <div class="avatar avatar-sm me-2">
                                                <img src="{{ url('admin/assets/img/avatars/1.png') }}" alt="Avatar"
                                                ...
                                                <ul
                                                    ...
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        <img class="rounded-circle"
                                                            src="{{ url('admin/assets/img/avatars/5.png') }}"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ url('admin/assets/img/avatars/12.png') }}"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ url('admin/assets/img/avatars/6.png') }}"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li class="avatar">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/chrome.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/safari.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/firefox.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/edge.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/opera.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/uc.png') }}"
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/windows.png') }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center gap-4">
                                                    <div class="progress w-100" style="height: 10px">
                                                        <div class="progress-bar bg-success" role="progressbar"
                                                            style="width: 61.5%" aria-valuenow="61.50" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/mac.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/ubuntu.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/cent.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ url('admin/assets/img/icons/brands/linux.png') }}"
